...
import { Printer, Download, Edit3, ArrowLeft, ZoomIn, ZoomOut, FileText, Loader2 } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl p-4 border border-slate-200/90 shadow-xs flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-1 text-xs font-medium text-slate-600">
            ...
            <span className="hidden sm:inline text-slate-500">Chuẩn văn bản khổ A4 (Times New Roman 13pt)</span>
          </div>
        </div>
